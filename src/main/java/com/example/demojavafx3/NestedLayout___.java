...
public class NestedLayout___ extends Application
{
   ...
   public void start(Stage primaryStage)
   {
      ...
      Image finlandImage = new Image(getClass().getResource("Finland.png").toExternalForm());//Image("file:Finland.png");
      Image germanyImage = new Image(getClass().getResource("Germany.png").toExternalForm());//Image("file:Germany.png");
